  ...
  const renderNavLinks = () => {
    return (
      <div className="headerList">
        ...
        {user && (
          <>
            <div className={`headerListItem ${location.pathname === '/reservation' ? 'active' : ''}`}>
            ...
            <div className={`headerListItem ${location.pathname === '/taxi' ? 'active' : ''}`}>
        ...
        {type !== "list" && (
          <>
            ...
            <p className="headerDesc">
              Is it your first time using Roomify? Unlock instant 10% saving with a free new account!
            </p>
